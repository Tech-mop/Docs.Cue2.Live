 ...
 *
 * Display format: v{major}.{minor}.{patch}:{CodeName}
 * Example: v0.1.1:StripyHat  (maps to Version.cs 0.1.1 / CodeName StripyHat)
 */
export const CUE2_CURRENT_VERSION = 'v0.1.1:StripyHat';
